...
namespace TestWebApplication.Areas.Identity.Pages.Account
{
    public class ForgotPasswordModel : PageModel
    {
        ...
        public async Task<IActionResult> OnPostAsync()
        {
            if (ModelState.IsValid)
            {
                ...
                //to.Add(obj.Email);
                to.Add(Input.Email);
                SendNotificationtoUser("Portal Service", "Reset Password", to, cc, $"Please reset your password by <a href='{HtmlEncoder.Default.Encode(callbackUrl)}'>clicking here</a>.");
