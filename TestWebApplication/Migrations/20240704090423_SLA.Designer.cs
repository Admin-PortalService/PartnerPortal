...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("TestWebApplication.Models.ViewModels.Contract", b =>
                {
            ...
            modelBuilder.Entity("TestWebApplication.Models.ViewModels.IncidentHistory", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("TestWebApplication.Models.ViewModels.SLAConfig", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("TestWebApplication.Models.ViewModels.User_Customer", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("TestWebApplication.Models.ViewModels.User_Customer", b =>
                {
                    b.HasOne("TestWebApplication.Models.ViewModels.Customer", "customer")
                        .WithMany()
                        .HasForeignKey("CustomerID")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("TestWebApplication.Models.ViewModels.UserAccess", "user")
                        .WithMany()
                        .HasForeignKey("UserID")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
